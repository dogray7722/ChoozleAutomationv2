...
public class PauseAccountFactory {
    ...
    @FindBy(how = How.LINK_TEXT,using = "Accounts")//pauseAccount
    WebElement accountsmanagement;

    @FindBy(how = How.XPATH,using = "//*[@id=\"accounts-list\"]/tbody/tr[1]/td[1]")//pauseAccount
    WebElement account2pause;

    @FindBy(how = How.XPATH,using = ".//*[@id='accounts-list']/tbody/tr[1]/td[6]/a[2]")//pauseAccount
    WebElement pauseAccount;

    @FindBy(how = How.XPATH,using = "//div[@class=\"large-2 columns\"]")//pauseAccount
    WebElement accounttypedd;

    @FindBy(how = How.XPATH,using = "//select[@name='account_state']/option[text()='Paused']")//pauseAccount
    WebElement paused;
    ...
    String account2PauseText = "";//pauseaccounttest

    public boolean isAlertPresent()//pauseaccounttest
    {
    ...
    public void pauseAccount() {//pauseaccounttest
    ...
    public void unpause()//pauseaccounttest
    {
    ...
    public void accountStatusArrow() { clickElement(accounttypedd);}//pauseaccounttest

    public void paused() { clickElement(paused); }//pauseaccounttest
